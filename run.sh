...
echo "### v7 — challenge-response (M2M)";  python3 ref/generate_challenge.py;   python3 ref/verify_challenge.py;   echo
echo "### v8 — entity-class";             python3 ref/generate_entity.py;      python3 ref/verify_entity.py;      echo
echo "### v9 — did-as-namespace";         python3 ref/generate_did_namespace.py; python3 ref/verify_did_namespace.py
echo
